...
func (clusterRequest *ClusterLoggingRequest) generateCollectorConfig() (config string, err error) {
	return clusterRequest.GenerateCollectorConfig(clusterRequest.includeLegacyForwardConfig, clusterRequest.includeLegacySyslogConfig, clusterRequest.useOldRemoteSyslogPlugin)
}
func (clusterRequest *ClusterLoggingRequest) GenerateCollectorConfig(includeLegacyForwardConfig, includeLegacySyslogConfig, useOldRemoteSyslogPlugin func() bool) (config string, err error) {
