...
|containerLimit|object|  *(optional)* PodLimit applied to each pod selected
...
|tuning|string|  *(optional)* Tuning are output specific config parameters applicable to vector
