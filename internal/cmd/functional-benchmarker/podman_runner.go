...
func NewPodmanRunner(collectorConfig string, totLogStressors, verbosity, msgSize, totMessages int) *PodmanRunner {
	var loglevel string
	switch verbosity {
	case 2:
		loglevel = "debug"
	...
	for i := 0; i < totLogStressors; i++ {
		stressor := podman.Run().
			...
			WithEnvVar("PAYLOAD_SIZE", strconv.Itoa(msgSize)).
			WithEnvVar("TOT_MSG", strconv.Itoa(totMessages))
...
func (r *PodmanRunner) deployCollector(tmpDir string) {
...
func (r *PodmanRunner) deployStressors(tmpDir string) {
...
func (r *PodmanRunner) deployReceivers(tmpDir string) {
...
func (r *PodmanRunner) writeCollectorConfig(dir string) {
...
func (r *PodmanRunner) WritesApplicationLogsOfSize(msgSize int) error {
	r.deployStressors(r.tmpDir)
	return nil
}

func (r *PodmanRunner) ReadApplicationLogs() ([]string, error) {
...
func (r *PodmanRunner) Metrics() Metrics {
